...
func (c *GitHubConnector) Operations() []api.OperationInfo {
...
func (c *GitHubConnector) OperationSchema(operation string) *api.OperationSchema {
...
func (c *GitHubConnector) defaultHeaders() map[string]string {

...
func TestNewSlackConnector(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			connector, err := NewSlackConnector(tt.config)
			if (err != nil) != tt.wantError {
				t.Errorf("NewSlackConnector() error = %v, wantError %v", err, tt.wantError)
				return
			}
...
func TestSlackConnector_Operations(t *testing.T) {
...
func TestSlackConnector_PostMessage(t *testing.T) {
	// Create mock server
...
func TestSlackConnector_UpdateMessage(t *testing.T) {
	// Create mock server
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		// Verify request
...
func TestSlackConnector_ListChannels(t *testing.T) {
	// Create mock server
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		// Verify request
...
func TestSlackConnector_ErrorHandling_OkFalse(t *testing.T) {
	tests := []struct {
		name          string
		errorCode     string
...
func TestSlackConnector_ErrorHandling_HTTPErrors(t *testing.T) {
	tests := []struct {
		name       string
		statusCode int
		wantError  bool
...
func TestSlackConnector_UnknownOperation(t *testing.T) {
	httpTransport, err := transport.NewHTTPTransport(&transport.HTTPTransportConfig{
		BaseURL: "https://slack.com/api",
	})
	if err != nil {
...
func TestSlackConnector_MissingRequiredParameters(t *testing.T) {
	httpTransport, err := transport.NewHTTPTransport(&transport.HTTPTransportConfig{
		BaseURL: "https://slack.com/api",
	})
	if err != nil {

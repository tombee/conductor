...
func (c *SlackConnector) Operations() []api.OperationInfo {
...
func (c *SlackConnector) OperationSchema(operation string) *api.OperationSchema {
...
func (c *SlackConnector) defaultHeaders() map[string]string {

...
func (c *JiraConnector) Operations() []api.OperationInfo {
...
func (c *JiraConnector) OperationSchema(operation string) *api.OperationSchema {
...
func (c *JiraConnector) defaultHeaders() map[string]string {
...
func (c *JiraConnector) ExecuteRequest(ctx context.Context, method, url string, headers map[string]string, body []byte) (*transport.Response, error) {

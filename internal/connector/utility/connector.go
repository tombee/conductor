// Package utility provides a builtin connector for utility functions.
//
// The utility connector provides general-purpose functions for:
...
// UtilityConnector implements the Connector interface for utility operations.
type UtilityConnector struct {
	config       *Config
	randomSource RandomSource
}

// Config holds configuration for the utility connector.
type Config struct {
...
// DefaultConfig returns sensible defaults for utility connector configuration.
...
// New creates a new utility connector instance.

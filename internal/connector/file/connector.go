...
//
// The file connector does NOT import the connector package to avoid import cycles.
// The builtin registry bridges between file operations and the Connector interface.
package file
...
// FileConnector implements the Connector interface for file operations.
...
// Config holds configuration for the file connector.
type Config struct {
...
// DefaultConfig returns sensible defaults for file connector configuration.
...
// New creates a new file connector instance.

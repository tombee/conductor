...
// DataDir returns the XDG data directory for Conductor
// On Unix: ~/.local/share/conductor
// On macOS: ~/.local/share/conductor
...
func DataDir() (string, error) {
	...
	dataDir := filepath.Join(base, "conductor")
...
// CacheDir returns the XDG cache directory for Conductor
// On Unix: ~/.cache/conductor
// On macOS: ~/.cache/conductor
...
func CacheDir() (string, error) {
	...
	cacheDir := filepath.Join(base, "conductor")

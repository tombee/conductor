...
func (c *DiscordIntegration) createWebhook(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
...
func (c *DiscordIntegration) sendWebhook(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
	// Validate required parameters

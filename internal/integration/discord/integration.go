...
func (c *DiscordIntegration) Execute(ctx context.Context, operation string, inputs map[string]interface{}) (*operation.Result, error) {
	switch operation {
	// Messages
	case "send_message":
...
func (c *DiscordIntegration) Operations() []api.OperationInfo {
...
func (c *DiscordIntegration) OperationSchema(operation string) *api.OperationSchema {
...
func (c *DiscordIntegration) defaultHeaders() map[string]string {
...
func (c *DiscordIntegration) ExecuteRequest(ctx context.Context, method, url string, headers map[string]string, body []byte) (*transport.Response, error) {

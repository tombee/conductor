...
func (c *JenkinsIntegration) getJob(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
...
func (c *JenkinsIntegration) listJobs(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {

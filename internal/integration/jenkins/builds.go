...
func (c *JenkinsIntegration) triggerBuild(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
...
func (c *JenkinsIntegration) triggerBuildWithParameters(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
	// Validate required parameters
...
func (c *JenkinsIntegration) getBuild(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
	// Validate required parameters
...
func (c *JenkinsIntegration) getBuildLog(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
	// Validate required parameters
	if err := c.ValidateRequired(inputs, []string{"job_name", "build_number"}); err != nil {
		return nil, err
	}
...
func (c *JenkinsIntegration) cancelBuild(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
	// Validate required parameters
	if err := c.ValidateRequired(inputs, []string{"job_name", "build_number"}); err != nil {
		return nil, err
	}
...
func (c *JenkinsIntegration) getLastBuild(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
	return c.getBuildInfo(ctx, inputs, "lastBuild")
}

// getLastSuccessfulBuild gets the last successful build info.
func (c *JenkinsIntegration) getLastSuccessfulBuild(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
	return c.getBuildInfo(ctx, inputs, "lastSuccessfulBuild")
}

// getLastFailedBuild gets the last failed build info.
func (c *JenkinsIntegration) getLastFailedBuild(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
	return c.getBuildInfo(ctx, inputs, "lastFailedBuild")
}

// getBuildInfo is a helper to get specific build info types.
func (c *JenkinsIntegration) getBuildInfo(ctx context.Context, inputs map[string]interface{}, buildType string) (*operation.Result, error) {
	// Validate required parameters
	if err := c.ValidateRequired(inputs, []string{"job_name"}); err != nil {
		return nil, err
	}
...
func (c *JenkinsIntegration) getTestReport(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
	// Validate required parameters
	if err := c.ValidateRequired(inputs, []string{"job_name", "build_number"}); err != nil {
		return nil, err
	}
...
func (c *JenkinsIntegration) addCrumb(ctx context.Context, headers map[string]string) error {
	// Try to get crumb
...
func (c *JenkinsIntegration) defaultHeaders() map[string]string {

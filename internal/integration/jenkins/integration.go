...
func (c *JenkinsIntegration) Execute(ctx context.Context, operation string, inputs map[string]interface{}) (*operation.Result, error) {
	switch operation {
	// Builds
	case "trigger_build":
...
func (c *JenkinsIntegration) Operations() []api.OperationInfo {
...
func (c *JenkinsIntegration) OperationSchema(operation string) *api.OperationSchema {

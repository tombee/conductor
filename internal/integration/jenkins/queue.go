...
func (c *JenkinsIntegration) getQueueItem(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
...
func (c *JenkinsIntegration) cancelQueueItem(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
	// Validate required parameters
	if err := c.ValidateRequired(inputs, []string{"queue_id"}); err != nil {
		return nil, err
	}

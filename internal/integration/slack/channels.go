...
func (c *SlackIntegration) listChannels(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
	// Build URL
...
func (c *SlackIntegration) createChannel(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
...
func (c *SlackIntegration) inviteToChannel(ctx context.Context, inputs map[string]interface{}) (*operation.Result, error) {
	// Validate required parameters

...
func TestDetectPlaintextCredentials(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantErrors:   1,
			wantStepID:   "integrations.github",
		...
		},
		{
			...
			wantErrors:   1,
			wantStepID:   "integrations.openai",
			wantType:     "plaintext_credential",
			wantSeverity: "error",
		},
		{
			...
			wantErrors:   1,
			wantStepID:   "integrations.anthropic",
			wantType:     "plaintext_credential",
			wantSeverity: "error",
		},
		{
		...
		},
		{
			...
			wantErrors:   1,
			wantStepID:   "integrations.database",
			wantType:     "plaintext_credential",
			wantSeverity: "error",
		},
		{
			...
			wantErrors:   1,
			wantStepID:   "integrations.oauth_app",
			wantType:     "plaintext_credential",
			wantSeverity: "error",
		},
		{
...
func TestCheckMissingAuth(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantWarnings: 1,
			wantStepID:   "integrations.gitlab",
			wantType:     "missing_auth",
		},
	}

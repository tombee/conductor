...
7. Copy your integration token (you'll use this to configure Conductor)
8. Copy the database ID from the URL (the 32-character string after the page name - you'll pass this when running the workflow)

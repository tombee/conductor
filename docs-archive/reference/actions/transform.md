...
The `transform` builtin action provides operations for parsing, extracting, and reshaping step outputs for downstream consumption.
...
- [File Action](file.md) - Read/write JSON, YAML, CSV

...
The `shell` action provides secure, sandboxed shell command execution for workflows.

## Overview

The shell action is a **builtin action** - it requires no configuration and is always available. It executes commands with security controls including timeouts, command allowlists, and sandboxing.
